...
- `small_profile_summary_2026-06-23.json`: reproducible small-tier geometry-1
  helical and geometry-4 W7-X-like probes for options 1, 2, and 3.
- `production_profile_summary_2026-06-23.json`: reproducible production-tier
  geometry-1 helical and geometry-4 W7-X-like probes for options 1, 2, and 3.

The 2026-06-23 summaries preserve the runner scratch/log paths, PETSc/KSP view
markers, per-evaluation forward and adjoint solve times, matrix nonzero counts,
peak RSS from `/usr/bin/time -lp`, and success/finalization markers. Raw logs
...
Do not collapse a small final residual into a convergence claim. The
`geometry1_helical_production_option2` Brent deck reached a small final radial
current but did not print Fortran's success marker within the 12-evaluation
budget. sfincs_jax tests should preserve both pieces of information.
