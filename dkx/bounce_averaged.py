...
limit (:mod:`dkx.shaing_callen`).  ``R_0 = G/B_0`` and, for the analytic
...
``iota`` of a :class:`dkx.magnetic_geometry.FluxSurfaceGeometry`.
"""
...
def deep_well_bounce_integrals(
    ...
    *,
    ...
    Args:
        geometry: a :class:`~dkx.magnetic_geometry.FluxSurfaceGeometry`.
