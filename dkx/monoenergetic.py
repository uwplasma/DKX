...
The RHSMode=3 ``transportMatrix`` computed by :mod:`dkx.moments`
...
DATABASE_SCHEMA = "dkx.monoenergetic_database.v1"
...
def save_database(path: str | Path, db: MonoenergeticDatabase, *, overwrite: bool = True) -> Path:
    ...
    Uses the generic :func:`dkx.io.write_sfincs_npz` serializer with
