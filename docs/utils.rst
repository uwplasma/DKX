...
The gallery figures above are release evidence, not first-pass examples. Use
the post-processing CLI on a generated output directory to regenerate a local
version of any panel, and keep large regenerated artifacts outside git.
