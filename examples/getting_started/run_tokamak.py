...
Run:
  python examples/getting_started/run_tokamak.py
"""
...
# ----------------------------------------------------------------------------
print("=== examples/getting_started/run_tokamak.py ===")
...
deck_lines = ["! SFINCS input generated by examples/getting_started/run_tokamak.py"]
...
print("Done: examples/getting_started/run_tokamak.py")
