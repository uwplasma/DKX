...
- Validation run: `pytest -q tests/test_cli_solve_mode.py tests/test_transport_parallel.py tests/test_rhs1_schwarz_heuristic.py` (`30 passed`); `python -m py_compile sfincs_jax/__init__.py sfincs_jax/cli.py tests/test_cli_solve_mode.py`; `sphinx-build -W -b html docs docs/_build/html`; local sharded benchmark variants via `python examples/performance/benchmark_sharded_solve_scaling.py ...`
