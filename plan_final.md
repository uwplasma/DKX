...
| --- | --- | --- |
| Whole package | 204 Python files, 165,574 package lines | `<=190` Python files and fewer package lines than this checkpoint for review-ready. Stretch target: `<=175` files if compatibility shims can be deleted safely. |
...
| `problems/transport_matrix` | 27 files including `parallel/`; 15,039 lines; many files are 50-600 line shards | `<=18` files for review-ready. Stretch target: `<=14` files including `parallel/`; `parallel/ <=3` files. |
