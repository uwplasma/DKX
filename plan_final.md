...
- Current burden is 115 package Python files / 137,038 package lines, 301 test files / 118,099 test lines, 90 example Python files / 14,898 example Python lines, and 374 tracked example files. These numbers must decrease; moving lines into more files is a failed tranche.
