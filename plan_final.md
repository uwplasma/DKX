...
- Current burden after the last cleanup is 116 package Python files / 141,442
  package lines, 301 test Python files / 121,507 test lines, 101 example Python
  files / 16,747 example Python lines, and 452 tracked example files after the
  staged optimization-example cleanup. These numbers must decrease by
...
| examples | 101 Python files / 16,747 lines and 452 tracked files | original v3 examples plus <=10 curated workflows |
