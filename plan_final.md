...
| tests | 300 Python files / 121,406 lines | <=120 files / <=70k lines while keeping >=95% coverage |
| examples | 100 Python files / 16,377 lines and 451 tracked files | original v3 examples plus <=10 curated workflows |
