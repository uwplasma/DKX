...
DEFAULT_EVIDENCE_ARTIFACTS = (
    ...
    / "docs"
    / "_static"
    / "qi_seed_robustness_scale060_residual_bounce_region_device_qi_cpu.json",
    REPO_ROOT
    / "docs"
    / "_static"
    / "qi_seed_robustness_scale060_residual_bounce_region_device_qi_gpu0.json",
    REPO_ROOT
    / "docs"
    / "_static"
...
OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_PROBE_PRESET = "operator-krylov-augmented-seed-device-qi"
...
OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_ENV = {
    **OPERATOR_KRYLOV_DEVICE_QI_ENV,
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_COMPOSE_WITH_BASE": "1",
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_COMPOSE_MODE": "multiplicative",
}
...
OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_ENV = {
    **AUGMENTED_KRYLOV_DEVICE_QI_ENV,
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_AUGMENTED_SEED": "1",
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_AUGMENTED_SEED_MAX_RANK": "8",
}
...
PHASE_SPACE_COARSE_REUSE_DEVICE_QI_ENV = {
    **RECYCLED_AUGMENTED_DEVICE_QI_ENV,
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_PHASE_SPACE_RESIDUAL_EQUATION": "1",
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_PHASE_SPACE_RESIDUAL_EQUATION_MAX_RANK": "32",
...
RESIDUAL_BOUNCE_REGION_DEVICE_QI_ENV = {
    **RECYCLED_AUGMENTED_DEVICE_QI_ENV,
    ...
    "SFINCS_JAX_RHSMODE1_XBLOCK_PC_QI_DEVICE_PRECONDITIONER_RESIDUAL_REGION_BOUNCE_COARSE_MAX_RANK": "48",
...
QI_DEVICE_TRACE_KEYS = (
    ...
    "xblock_qi_device_preconditioner_phase_space_residual_equation",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_max_rank",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_candidate_count",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_rank",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_stage_count",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_solver",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_condition_estimate",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_residual_before",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_residual_after",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_include_global",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_trapped_boundary_fraction",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_include_radial",
    "xblock_qi_device_preconditioner_phase_space_residual_equation_include_species",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_max_rank",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_candidate_count",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_rank",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_stage_count",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_solver",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_condition_estimate",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_residual_before",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_residual_after",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_include_global",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_include_radial",
    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_include_species",
    ...
    "xblock_qi_device_preconditioner_augmented_seed_rank",
    "xblock_qi_device_preconditioner_augmented_seed_max_rank",
    "xblock_qi_device_preconditioner_augmented_seed_reason",
    "xblock_qi_device_preconditioner_augmented_seed_projection_residual_norm",
    "xblock_qi_device_preconditioner_augmented_seed_labels",
    ...
    "xblock_qi_device_preconditioner_coupled_residual_equation",
    "xblock_qi_device_preconditioner_coupled_residual_equation_max_rank",
    ...
    "xblock_qi_device_preconditioner_coupled_residual_equation_source_stage_count",
...
def _probe_env_for_preset(preset: str) -> dict[str, str]:
    ...
    if normalized == OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_PROBE_PRESET:
        return dict(OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_ENV)
    ...
    if normalized == OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_PROBE_PRESET:
        return dict(OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_ENV)
    ...
    if normalized == PHASE_SPACE_COARSE_REUSE_DEVICE_QI_PROBE_PRESET:
...
def _command_with_option(command: list[str], option: str, value: str) -> list[str]:
    """Return ``command`` with a single CLI option value replaced or appended."""
...
def _solver_trace_summary(trace_path: Path) -> dict[str, object] | None:
    ...
    if isinstance(qi_device_metadata, dict):
        nested_block_schur_keys = {
            ...
            "xblock_qi_device_preconditioner_phase_space_residual_equation": (
                "phase_space_residual_equation_enabled"
            ),
            "xblock_qi_device_preconditioner_phase_space_residual_equation_max_rank": (
            ...
            "xblock_qi_device_preconditioner_phase_space_residual_equation_stage_count": (
                "phase_space_residual_equation_stage_count"
            ),
            "xblock_qi_device_preconditioner_phase_space_residual_equation_solver": (
            ...
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse": (
                "residual_region_bounce_coarse_enabled"
            ),
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse_max_rank": (
            ...
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse_stage_count": (
                "residual_region_bounce_coarse_stage_count"
            ),
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse_solver": (
            ...
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse_bounce_boundary": (
                "residual_region_bounce_coarse_bounce_boundary"
            ),
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse_min_region_energy_fraction": (
            ...
            "xblock_qi_device_preconditioner_coupled_residual_equation": (
                "coupled_residual_equation_enabled"
            ),
            "xblock_qi_device_preconditioner_coupled_residual_equation_candidate_count": (
                "coupled_residual_equation_candidate_count"
            ),
            "xblock_qi_device_preconditioner_coupled_residual_equation_rank": (
                "coupled_residual_equation_rank"
            ),
            "xblock_qi_device_preconditioner_coupled_residual_equation_source_stage_count": (
            ...
            "xblock_qi_device_preconditioner_coupled_residual_equation_accepted": (
                "coupled_residual_equation_accepted"
            ),
            "xblock_qi_device_preconditioner_coupled_residual_equation_reason": (
...
def _log_key_value(text: object, key: str) -> str | None:
    """Return one key=value token while preserving comma-delimited values."""

    match = re.search(rf"\b{re.escape(key)}=(?P<value>[^\s)]+)", str(text))
    if match is None:
        return None
...
def _infer_qi_device_progress(events: Iterable[object]) -> dict[str, object]:
    ...
    for event in events:
        ...
        if "QI device preconditioner phase-space residual equation" in text:
            key_values = _log_key_values(text)
            summary.update(
                {
                    ...
                    "xblock_qi_device_preconditioner_phase_space_residual_equation_trapped_boundary_fraction": (
                        _float_from_log_value(key_values.get("boundary"))
                    ),
                    "xblock_qi_device_preconditioner_phase_space_residual_equation_include_radial": (
                        _bool_from_log_value(key_values.get("radial"))
                    ),
                    "xblock_qi_device_preconditioner_phase_space_residual_equation_include_species": (
                        _bool_from_log_value(key_values.get("species"))
                    ),
                }
            )
        if (
            "QI device preconditioner residual-region/bounce coarse" in text
            or "QI device preconditioner residual-region bounce coarse" in text
            or "QI device preconditioner bounce-region coarse" in text
        ):
            key_values = _log_key_values(text)
            region_bands = _log_key_value(text, "region_bands") or _log_key_value(text, "bands")
            residual_before = _float_from_log_value(
                key_values.get("residual_before")
                or key_values.get("before")
            )
            residual_after = _float_from_log_value(
                key_values.get("residual_after")
                or key_values.get("after")
            )
            summary.update(
                {
                    ...
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_rank": (
                        _int_from_log_value(key_values.get("rank"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_candidate_count": (
                        _int_from_log_value(key_values.get("candidate_count") or key_values.get("candidates"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_stage_count": (
                        _int_from_log_value(key_values.get("stage_count") or key_values.get("stages"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_solver": (
                        key_values.get("solver")
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_condition_estimate": (
                        _float_from_log_value(key_values.get("condition_estimate") or key_values.get("condition"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_residual_before": (
                        residual_before
                    ),
                    ...
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_include_global": (
                        _bool_from_log_value(key_values.get("include_global") or key_values.get("global"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_include_radial": (
                        _bool_from_log_value(key_values.get("include_radial") or key_values.get("radial"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_include_species": (
                        _bool_from_log_value(key_values.get("include_species") or key_values.get("species"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_bounce_boundary": (
                        _float_from_log_value(key_values.get("bounce_boundary") or key_values.get("boundary"))
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_min_region_energy_fraction": (
                        _float_from_log_value(
                            key_values.get("min_region_energy_fraction")
                            or key_values.get("min_energy")
                        )
                    ),
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_region_bands": (
                        region_bands
        ...
        if "QI device preconditioner coupled residual equation" in text:
            key_values = _log_key_values(text)
            summary.update(
                {
                    ...
                    "xblock_qi_device_preconditioner_coupled_residual_equation_min_relative_improvement": (
                        _float_from_log_value(
                            ...
                            or key_values.get("min_relative_improvement")
                        )
                    ),
                }
            )
        ...
        residual_region_bounce_flag = _bool_from_log_value(
            key_values.get("residual_bounce_region")
            or key_values.get("residual_region_bounce")
            or key_values.get("bounce_region")
        )
        residual_region_bounce_candidates = _int_from_log_value(
            key_values.get("residual_bounce_candidates")
            or key_values.get("residual_region_bounce_candidates")
            or key_values.get("bounce_region_candidates")
        )
        residual_region_bounce_rank = _int_from_log_value(
        ...
        coupled_flag = _bool_from_log_value(
            key_values.get("coupled_equation") or key_values.get("coupled_residual_equation")
        )
        coupled_candidates = _int_from_log_value(
            key_values.get("coupled_candidates")
            or key_values.get("coupled_residual_equation_candidates")
        )
        coupled_rank = _int_from_log_value(
            key_values.get("coupled_rank")
            or key_values.get("coupled_residual_equation_rank")
        )
        summary.update({
            "xblock_qi_device_preconditioner_enabled": True,
            "xblock_qi_device_preconditioner_built": True,
            ...
            "xblock_qi_device_preconditioner_phase_space_residual_equation": _bool_from_log_value(
                key_values.get("phase_space_equation")
            ),
            "xblock_qi_device_preconditioner_phase_space_residual_equation_candidate_count": (
                _int_from_log_value(key_values.get("phase_space_candidates"))
            ),
            "xblock_qi_device_preconditioner_phase_space_residual_equation_rank": (
                _int_from_log_value(key_values.get("phase_space_rank"))
            ),
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse": (
                residual_region_bounce_flag
                if residual_region_bounce_flag is not None
                else summary.get("xblock_qi_device_preconditioner_residual_region_bounce_coarse")
            ),
            "xblock_qi_device_preconditioner_residual_region_bounce_coarse_candidate_count": (
                residual_region_bounce_candidates
                if residual_region_bounce_candidates is not None
                else summary.get(
                    "xblock_qi_device_preconditioner_residual_region_bounce_coarse_candidate_count"
                )
            ),
            ...
            "xblock_qi_device_preconditioner_coupled_residual_equation": (
                coupled_flag
                if coupled_flag is not None
                else summary.get("xblock_qi_device_preconditioner_coupled_residual_equation")
            ),
            "xblock_qi_device_preconditioner_coupled_residual_equation_candidate_count": (
                coupled_candidates
                if coupled_candidates is not None
                else summary.get(
                    "xblock_qi_device_preconditioner_coupled_residual_equation_candidate_count"
                )
            ),
            "xblock_qi_device_preconditioner_coupled_residual_equation_rank": (
                coupled_rank
                if coupled_rank is not None
                else summary.get("xblock_qi_device_preconditioner_coupled_residual_equation_rank")
            ),
...
def _seed_evidence_classification(seed: dict[str, object], probe_env: object) -> dict[str, object]:
    ...
    requested_augmented_seed = _env_flag(
        probe_env,
    ...
    requested_coupled_residual_equation = _env_flag(
        probe_env,
    ...
    if requested_augmented_seed:
        tags.add("requested_augmented_seed")
    ...
    observed_augmented_seed = seed.get("xblock_qi_device_preconditioner_augmented_seed_used") is True
    ...
    observed_phase_space = (
        seed.get("xblock_qi_device_preconditioner_phase_space_residual_equation") is True
    )
    ...
    if observed_augmented_seed:
        tags.add("observed_augmented_seed")
    ...
    if observed_installed_krylov and observed_coarse_reuse and observed_augmented_seed:
        ...
        classification = "device_qi_phase_space_residual_equation_coarse_reuse"
    elif observed_installed_krylov and observed_coarse_reuse and observed_residual_galerkin:
    ...
    elif observed_installed_krylov and observed_coarse_reuse and observed_coupled_residual_equation:
        classification = "device_qi_coupled_residual_equation_reuse"
        ...
        classification = "requested_augmented_seed_device_qi"
    ...
    return {
        ...
        "requested_augmented_seed": requested_augmented_seed,
        ...
        "observed_augmented_seed": observed_augmented_seed,
...
def _aggregate_seed_classifications(seed_summaries: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        ...
        "has_observed_phase_space_residual_equation": any(
            seed.get("observed_qi_device_phase_space_residual_equation") is True for seed in seed_list
        ),
        ...
        seed_summary.update(
            {
                ...
                "requested_qi_device_phase_space_residual_equation": classification[
                    "requested_phase_space"
                ],
                ...
                "observed_qi_device_phase_space_residual_equation": classification[
                    "observed_phase_space"
                ],
...
def _artifact_fail_closed(payload: dict[str, object]) -> bool:
    """Return true when an artifact records blocker evidence rather than promotion evidence."""
    ...
    if isinstance(summary, dict):
        for key in ("process_failed", "timed_out"):
            try:
    ...
    if any(outcome != "process_passed" for outcome in outcomes):
        return True
    ...
    if tags.intersection(
        {
            ...
            "no_hdf5_output",
            "not_converged",
            "not_accepted_converged",
        }
    ):
        return True

    promotion_count = _finite_float_or_none(embedded.get("promotion_eligible_seed_count"))
    classes = {str(item) for item in embedded.get("classes", []) if item}
    return promotion_count == 0 and any(class_name.startswith("device_qi_") for class_name in classes)


def _fail_closed_evidence_classes(classes: Iterable[str], tags: Iterable[str]) -> list[str]:
    """Downgrade observed device-QI classes to requested-only classes for fail-closed artifacts."""
    class_set = {str(class_name) for class_name in classes if class_name}
    tag_set = {str(tag) for tag in tags if tag}
    promoted_classes = {class_name for class_name in class_set if class_name.startswith("device_qi_")}
    if not promoted_classes:
    ...
    if "active_pattern" in text or "active-pattern" in text:
        ...
        downgraded.add("requested_residual_galerkin_equation_device_qi")
    elif "global_moment" in text or "global-moment" in text:
        downgraded.add("requested_global_moment_residual_equation_device_qi")
    elif "coupled_residual_equation" in text or "coupled-residual" in text:
        downgraded.add("requested_coupled_residual_equation_device_qi")
    elif "block_schur" in text or "block-schur" in text:
        downgraded.add("requested_block_schur_residual_device_qi")
    elif "residual_snapshot_residual_equation" in text or "residual-snapshot-equation" in text:
        downgraded.add("requested_residual_snapshot_residual_equation_device_qi")
    elif "residual_snapshot" in text or "residual-snapshot" in text:
        downgraded.add("requested_residual_snapshot_device_qi")
    elif "multilevel_residual_equation" in text or "coarse-residual" in text:
        downgraded.add("requested_multilevel_residual_equation_device_qi")
    elif "augmented_seed" in text or "augmented-seed" in text:
        downgraded.add("requested_augmented_seed_device_qi")
    elif "augmented_krylov" in text or "augmented-krylov" in text:
        downgraded.add("requested_augmented_krylov_device_qi")
    elif "operator_krylov" in text or "operator-krylov" in text or "installed_krylov" in text:
        downgraded.add("requested_operator_krylov_device_qi")
    else:
        downgraded.add("requested_device_qi")
    return sorted(downgraded)


def _fail_closed_evidence_tags(tags: Iterable[str]) -> list[str]:
    return sorted({str(tag) for tag in tags if tag and not str(tag).startswith("observed_")})


def _artifact_passed(payload: dict[str, object]) -> bool:
    if _artifact_fail_closed(payload):
        return False
    gates = payload.get("gates")
...
def _artifact_evidence_classification(path: Path, payload: dict[str, object]) -> dict[str, object]:
    ...
    if isinstance(embedded, dict):
        raw_classes = [str(item) for item in embedded.get("classes", []) if item]
        raw_tags = [str(item) for item in embedded.get("tags", []) if item]
        classes = list(raw_classes)
        tags = list(raw_tags)
        outcomes = [str(item) for item in embedded.get("outcomes", []) if item]
        fail_closed = _artifact_fail_closed(payload)
        if fail_closed:
            classes = _fail_closed_evidence_classes(classes, tags)
            tags = _fail_closed_evidence_tags(tags)
            if not outcomes:
                outcomes = ["process_failed"]
        fail_closed_observed_classes = (
            sorted({class_name for class_name in raw_classes if class_name.startswith("device_qi_")})
            if fail_closed
            else []
        )
        fail_closed_observed_tags = (
            sorted({tag for tag in raw_tags if tag.startswith("observed_")}) if fail_closed else []
        )
        return {
            ...
            "fail_closed_observed_classes": fail_closed_observed_classes,
            "fail_closed_observed_tags": fail_closed_observed_tags,
            "has_failed_before_summary_json": bool(embedded.get("has_failed_before_summary_json")),
            "has_observed_installed_krylov": False
            if fail_closed
            else bool(embedded.get("has_observed_installed_krylov")),
            "has_observed_coarse_reuse": False if fail_closed else bool(embedded.get("has_observed_coarse_reuse")),
            "has_observed_multilevel_residual_equation": False
            if fail_closed
            else bool(embedded.get("has_observed_multilevel_residual_equation")),
            "has_observed_residual_snapshot": False
            if fail_closed
            else bool(embedded.get("has_observed_residual_snapshot")),
            "has_observed_global_moment_residual_equation": False
            if fail_closed
            else bool(embedded.get("has_observed_global_moment_residual_equation")),
            "has_observed_residual_galerkin_equation": False
            if fail_closed
            else bool(embedded.get("has_observed_residual_galerkin_equation")),
            "has_observed_phase_space_residual_equation": False
            if fail_closed
            else bool(embedded.get("has_observed_phase_space_residual_equation")),
            ...
            "has_observed_coupled_residual_equation": False
            if fail_closed
            else bool(embedded.get("has_observed_coupled_residual_equation")),
            "promotion_eligible_seed_count": 0 if fail_closed else embedded.get("promotion_eligible_seed_count"),
        }
    ...
    seeds = payload.get("seeds")
    seed_list = [seed for seed in seeds if isinstance(seed, dict)] if isinstance(seeds, list) else []

    def _any_seed_true(*keys: str) -> bool:
        return any(seed.get(key) is True for seed in seed_list for key in keys)

    def _any_seed_has(*keys: str) -> bool:
        return any(key in seed for seed in seed_list for key in keys)

    residual_bounce_observed_in_seed = _any_seed_true(
    ...
    if "residual_galerkin" in text or "residual-galerkin" in text:
        tags.add("requested_residual_galerkin_equation")
    if "phase_space" in text or "phase-space" in text:
        tags.add("requested_phase_space_residual_equation")
    if (
        "residual_region_bounce" in text
        or "residual-bounce-region" in text
        or "requested_qi_device_residual_bounce" in text
        or "observed_qi_device_residual_bounce" in text
        or "bounce_region" in text
    ...
    if "block_schur" in text or "block-schur" in text:
        tags.add("requested_block_schur_residual")
    if "coupled_residual_equation" in text or "coupled-residual" in text:
        tags.add("requested_coupled_residual_equation")
    if "solver_traces_written\": 0" in text or "solver_trace_exists\": false" in text:
        tags.add("failed_before_solver_trace_summary")

    if residual_bounce_observed_in_seed or (
        not residual_bounce_observed_key_present
        and (
            "observed_residual_bounce_region_coarse" in text
            or "observed_qi_device_residual_bounce_region" in text
        )
    ):
        ...
        "observed_coupled_residual_equation" in text
        or "observed_qi_device_coupled_residual_equation" in text
    ):
        classes.add("device_qi_coupled_residual_equation_reuse")
        ...
        classes.add("requested_phase_space_residual_equation_device_qi")
    elif (
        "residual_region_bounce" in text
        or "residual-bounce-region" in text
        or "requested_qi_device_residual_bounce" in text
        ...
        classes.add("requested_coupled_residual_equation_device_qi")
    elif "block_schur" in text or "block-schur" in text:
    ...
    return {
        ...
        "has_observed_phase_space_residual_equation": "observed_phase_space_residual_equation" in text,
        "has_observed_residual_bounce_region_coarse": residual_bounce_observed_in_seed
        or (
            not residual_bounce_observed_key_present
        ...
        "has_observed_coupled_residual_equation": "observed_coupled_residual_equation" in text,
...
def _summarize_evidence_artifact(path: Path, payload: dict[str, object], production_resolution: dict[str, int]) -> dict[str, object]:
    ...
    return {
        ...
        "evidence_tags": classification["tags"],
        "fail_closed_observed_classes": classification.get("fail_closed_observed_classes", []),
        "fail_closed_observed_tags": classification.get("fail_closed_observed_tags", []),
...
def build_evidence_manifest(
    *,
    ...
    def _gpu0_probe_command_for_preset(preset: str) -> list[str]:
        preset_slug = str(preset).replace("-", "_")
        return [
            "python",
            "scripts/run_qi_seed_robustness.py",
            "--out-root",
            f"tests/qi_seed_robustness_scale060_{preset_slug}_gpu0",
            "--seeds",
            "3",
            "--resolution-scale",
            "0.60",
            ...
            "15",
            "--summary-output",
            f"docs/_static/qi_seed_robustness_scale060_{preset_slug}_gpu0.json",
            "--clean",
        ]

    operator_krylov_probe_command = _gpu0_probe_command_for_preset(OPERATOR_KRYLOV_DEVICE_QI_PROBE_PRESET)
    ...
    operator_krylov_composite_probe_command = _gpu0_probe_command_for_preset(
        OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_PROBE_PRESET
    )
    operator_krylov_composite_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_ENV,
    }
    current_constraint_probe_command = _gpu0_probe_command_for_preset(CURRENT_CONSTRAINT_DEVICE_QI_PROBE_PRESET)
    current_constraint_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **CURRENT_CONSTRAINT_DEVICE_QI_ENV,
    }
    adjoint_krylov_probe_command = _gpu0_probe_command_for_preset(ADJOINT_KRYLOV_DEVICE_QI_PROBE_PRESET)
    adjoint_krylov_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **ADJOINT_KRYLOV_DEVICE_QI_ENV,
    }
    augmented_krylov_probe_command = _gpu0_probe_command_for_preset(AUGMENTED_KRYLOV_DEVICE_QI_PROBE_PRESET)
    augmented_krylov_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **AUGMENTED_KRYLOV_DEVICE_QI_ENV,
    }
    operator_krylov_augmented_seed_probe_command = _gpu0_probe_command_for_preset(
        OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_PROBE_PRESET
    )
    operator_krylov_augmented_seed_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_ENV,
    }
    recycled_augmented_probe_command = _gpu0_probe_command_for_preset(
        RECYCLED_AUGMENTED_DEVICE_QI_PROBE_PRESET
    )
    ...
    coarse_residual_probe_command = _gpu0_probe_command_for_preset(COARSE_RESIDUAL_DEVICE_QI_PROBE_PRESET)
    coarse_residual_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **COARSE_RESIDUAL_DEVICE_QI_ENV,
    }
    residual_snapshot_probe_command = _gpu0_probe_command_for_preset(RESIDUAL_SNAPSHOT_DEVICE_QI_PROBE_PRESET)
    residual_snapshot_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **RESIDUAL_SNAPSHOT_DEVICE_QI_ENV,
    }
    residual_snapshot_equation_probe_command = _gpu0_probe_command_for_preset(
        RESIDUAL_SNAPSHOT_EQUATION_DEVICE_QI_PROBE_PRESET
    )
    ...
    assembled_reuse_probe_command = _gpu0_probe_command_for_preset(ASSEMBLED_REUSE_DEVICE_QI_PROBE_PRESET)
    assembled_reuse_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **ASSEMBLED_REUSE_DEVICE_QI_ENV,
    }
    composite_closure_probe_command = _gpu0_probe_command_for_preset(COMPOSITE_CLOSURE_DEVICE_QI_PROBE_PRESET)
    composite_closure_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **COMPOSITE_CLOSURE_DEVICE_QI_ENV,
    }
    global_moment_probe_command = _gpu0_probe_command_for_preset(GLOBAL_MOMENT_CLOSURE_DEVICE_QI_PROBE_PRESET)
    global_moment_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **GLOBAL_MOMENT_CLOSURE_DEVICE_QI_ENV,
    }
    residual_galerkin_probe_command = _gpu0_probe_command_for_preset(
        RESIDUAL_GALERKIN_DEVICE_QI_PROBE_PRESET
    )
    ...
    phase_space_coarse_reuse_probe_command = _gpu0_probe_command_for_preset(
        PHASE_SPACE_COARSE_REUSE_DEVICE_QI_PROBE_PRESET
    )
    phase_space_coarse_reuse_probe_env = {
        "CUDA_VISIBLE_DEVICES": "0",
        "JAX_PLATFORM_NAME": "gpu",
        **PHASE_SPACE_COARSE_REUSE_DEVICE_QI_ENV,
    }
    residual_bounce_region_probe_command = _gpu0_probe_command_for_preset(
        RESIDUAL_BOUNCE_REGION_DEVICE_QI_PROBE_PRESET
    )
    ...
    coupled_residual_probe_command = _gpu0_probe_command_for_preset(
        COUPLED_RESIDUAL_DEVICE_QI_PROBE_PRESET
    )
    ...
    return {
        ...
        "regeneration_commands": {
            ...
            "operator_krylov_composite_device_qi_gpu0_probe": _shell_command(
                operator_krylov_composite_probe_command,
                operator_krylov_composite_probe_env,
            ),
            ...
            "operator_krylov_augmented_seed_device_qi_gpu0_probe": _shell_command(
                operator_krylov_augmented_seed_probe_command,
                operator_krylov_augmented_seed_probe_env,
            ),
            ...
            "phase_space_coarse_reuse_device_qi_gpu0_probe": _shell_command(
                phase_space_coarse_reuse_probe_command,
                phase_space_coarse_reuse_probe_env,
            ),
            ...
            "coupled_residual_device_qi_gpu0_probe": _shell_command(
                coupled_residual_probe_command,
                coupled_residual_probe_env,
            ),
        ...
        "probe_presets": {
            ...
            OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_PROBE_PRESET: {
                "description": (
                    "Bounded scale-0.60 hard-seed GPU0 production probe for true device-QI "
                    "operator-Krylov enrichment composed with the base x-block path. This is "
                    "an explicit fail-closed research probe for the next algorithmic lane, "
                    "not a public default-policy solve."
                ),
                "env": dict(sorted(OPERATOR_KRYLOV_COMPOSITE_DEVICE_QI_ENV.items())),
            ...
            OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_PROBE_PRESET: {
                "description": (
                    "Bounded scale-0.60 hard-seed GPU0 production probe that recycles "
                    "accepted device-QI seed correction directions into the augmented "
                    "FGMRES coarse space. This is the next non-smoother closure attempt "
                    "and remains fail-closed until it writes converged output."
                ),
                "env": dict(sorted(OPERATOR_KRYLOV_AUGMENTED_SEED_DEVICE_QI_ENV.items())),
                "recommended_command": _shell_command(
                    operator_krylov_augmented_seed_probe_command,
                    operator_krylov_augmented_seed_probe_env,
                ),
            ...
            PHASE_SPACE_COARSE_REUSE_DEVICE_QI_PROBE_PRESET: {
                "description": (
                    "Bounded scale-0.60 hard-seed GPU0 production probe for the "
                    "phase-space residual-equation coarse-reuse path. This adds "
                    "trapped/passing, boundary, parity, radial, and species coarse "
                    "directions to the reusable device-QI operator action and remains "
                    "fail-closed unless output, solver trace, and convergence are observed."
                ),
                "env": dict(sorted(PHASE_SPACE_COARSE_REUSE_DEVICE_QI_ENV.items())),
                "recommended_command": _shell_command(
                    phase_space_coarse_reuse_probe_command,
                    phase_space_coarse_reuse_probe_env,
                ),
            ...
            RESIDUAL_BOUNCE_REGION_DEVICE_QI_PROBE_PRESET: {
                "description": (
                    ...
                    "residual-region/bounce-region coarse path. The runtime hook "
                    "builds deterministic residual-restricted trapped/boundary/"
                    "passing coarse directions and classifies observed metadata, "
                    "but remains fail-closed and promotion-ineligible unless "
                    "output, solver trace, and convergence are observed."
                ),
                "env": dict(sorted(RESIDUAL_BOUNCE_REGION_DEVICE_QI_ENV.items())),
                "recommended_command": _shell_command(
                    residual_bounce_region_probe_command,
                    residual_bounce_region_probe_env,
                ),
            ...
            COUPLED_RESIDUAL_DEVICE_QI_PROBE_PRESET: {
                "description": (
                    "Bounded scale-0.60 hard-seed GPU0 production probe for the "
                    "coupled residual-equation path. This replaces the staged "
                    "coarse corrections with one joint action least-squares "
                    "residual equation over multilevel, block-Schur, residual-"
                    "snapshot, and flat coarse spaces. It remains fail-closed "
                    "unless output, solver trace, convergence, and observed "
                    "coupled residual-equation metadata are present."
                ),
                "env": dict(sorted(COUPLED_RESIDUAL_DEVICE_QI_ENV.items())),
                "recommended_command": _shell_command(
                    coupled_residual_probe_command,
                    coupled_residual_probe_env,
                ),
        ...
        "open_blockers": [
            ...
            "Keep the augmented-seed operator-Krylov device-QI probe fail-closed until a converged artifact reports observed augmented-seed metadata.",
            ...
            "Keep the phase-space coarse-reuse device-QI probe fail-closed until a converged artifact reports observed phase-space residual-equation metadata.",
            "Keep the residual-region/bounce-region device-QI probe fail-closed until a converged artifact reports observed residual-bounce coarse metadata.",
            ...
            "Keep the coupled residual-equation device-QI probe fail-closed until a converged artifact reports observed coupled-equation metadata.",
