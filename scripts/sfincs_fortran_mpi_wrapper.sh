...
# SFINCS_FORTRAN_MPI_NP to the number of MPI ranks. If mpirun is unavailable,
# fall back to launching the executable directly.
...
np="${SFINCS_FORTRAN_MPI_NP:-${SFINCS_MPI_NP:-4}}"
