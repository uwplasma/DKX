...
across ``sfincs_jax/outputs/transport.py`` (``conversion_factors_to_from_dpsi_hat``),
``sfincs_jax/outputs/writer.py`` (physics-parameter defaults), and
``sfincs_jax/operators/profile_*.py`` (``_V3_DEFAULT_DELTA`` / ``_V3_DEFAULT_NU_N``).
It becomes ``sfincs_jax/constants.py`` at the v2 purge.
