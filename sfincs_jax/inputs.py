...
``sfincs_jax/namelist.py`` (no f90nml dependency: f90nml is not a project
...
# --------------------------------------------------------------------------
# Low-level Fortran-namelist parser (proven logic from sfincs_jax/namelist.py)
# --------------------------------------------------------------------------
...
def _validate(inp: SfincsInput) -> SfincsInput:
    """Replicate the checks of validateInput.F90 that sfincs_jax relies on.
