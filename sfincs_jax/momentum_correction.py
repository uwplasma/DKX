...
:mod:`sfincs_jax.monoenergetic` are computed with the pitch-angle-scattering
...
# shared with :mod:`sfincs_jax.monoenergetic` (1 - f_c = 1.46 sqrt(eps_t)).
...
def _physical_d31_d33(
    ...
    *,
    ...
    :func:`sfincs_jax.monoenergetic.energy_convolution` (same database lookup
