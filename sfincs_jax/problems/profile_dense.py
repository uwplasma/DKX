...
def try_rhs1_auto_host_solve(context: RHS1AutoHostSolveContext) -> Any | None:
    """Early host solver routes for ``auto`` (none remain; the assembled-CSR
    and Fortran-reduced sparse-PC lanes were removed with the legacy sparse
    families — the matrix-free policy owns all retained legacy solves)."""
