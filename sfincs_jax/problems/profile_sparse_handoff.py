...
_LOCAL_EXPORTS = (
    ...
    "SparsePCTrueCoupledCoarseStageResult", "XBlockAssembledOperatorBuildResult",
    "XBlockGlobalCouplingStageContext", "XBlockGlobalCouplingStageResult",
    "XBlockLocalPreconditionerBuildResult", "XBlockMomentSchurStageContext",
    "XBlockMomentSchurStageResult", "XBlockSparsePCBranchSetup",
    "XBlockTwoLevelStageContext", "XBlockTwoLevelStageResult",
    "apply_sparse_pc_residual_candidate_update",
    "apply_xblock_global_coupling_stage", "apply_xblock_moment_schur_stage",
    "apply_xblock_two_level_stage", "build_xblock_assembled_operator_if_requested",
    "build_xblock_local_preconditioner", "build_sparse_pc_direct_tail_factor_setup",
    "build_sparse_pc_direct_tail_rescue_policy_setup",
