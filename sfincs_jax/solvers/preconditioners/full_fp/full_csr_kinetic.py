...
class RHS1FullCSRKineticPreconditioner:
    ...
    def apply_native(self, rhs: Any) -> np.ndarray:
        ...
        from sfincs_jax.solvers.native_block_factor import apply_native_x_ell_kinetic_factor  # noqa: PLC0415
...
def build_rhs1_full_csr_kinetic_preconditioner(
    *,
    ...
    if bool(build_native_factor):
        from sfincs_jax.solvers.native_block_factor import build_native_x_ell_kinetic_factor  # noqa: PLC0415
