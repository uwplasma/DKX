...
ACTIVE_PACKAGE_EXPORTS = {
    ...
    # The ambipolar E_r problem moved to the canonical stack (sfincs_jax.er);
    # the legacy problems/ambipolar.py Brent/Newton owner was deleted.
    "sfincs_jax.problems": (),
...
ROOT_MODULE_CLOSURE_MANIFEST = {
    ...
    "collisions.py": ("canonical collision-operator owner", "keep at root as canonical stack module"),
    "console.py": ("canonical Fortran-parity stdout owner", "keep at root as canonical stack module"),
    "constants.py": ("canonical normalization/radial-coordinate owner", "keep at root as canonical stack module"),
    "drift_kinetic.py": ("canonical KineticOperator owner", "keep at root as canonical stack module"),
    "er.py": ("canonical ambipolar-Er owner", "keep at root as canonical stack module"),
    "inputs.py": ("canonical typed-namelist owner", "keep at root as canonical stack module"),
    "magnetic_geometry.py": ("canonical flux-surface geometry owner", "keep at root as canonical stack module"),
    "moments.py": ("canonical velocity-space moments owner", "keep at root as canonical stack module"),
    "phase_space.py": ("canonical grids/discretization owner", "keep at root as canonical stack module"),
    "phi1.py": ("canonical Phi1/quasineutrality owner", "keep at root as canonical stack module"),
    ...
    "ambipolar.py": ("scanplot-compatible ambipolar post-processing (sfincsScanPlot_5)", "keep root helper; in-process ambipolar solves live in er.py"),
