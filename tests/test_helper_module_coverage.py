...
from sfincs_jax.problems.transport_parallel_worker import main as transport_worker_main
...
def test_transport_parallel_worker_writes_npz(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("sfincs_jax.problems.transport_parallel_worker.read_sfincs_input", lambda _p: object())
    monkeypatch.setattr(
        "sfincs_jax.problems.transport_parallel_worker.solve_v3_transport_matrix_linear_gmres",
