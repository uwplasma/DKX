...
Run (from the repo root):
  python tools/paper_benchmarks/bootstrap_consistency_kinetic_loop.py
"""
...
! Generated by tools/paper_benchmarks/bootstrap_consistency_kinetic_loop.py
&general
  RHSMode = 1
/
&geometryParameters
...
print("=== tools/paper_benchmarks/bootstrap_consistency_kinetic_loop.py ===", flush=True)
if not DECK.exists():
    raise SystemExit(
