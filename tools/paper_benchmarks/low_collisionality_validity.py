...
Run (from the repo root):
  python tools/paper_benchmarks/low_collisionality_validity.py
"""
...
! Generated by tools/paper_benchmarks/low_collisionality_validity.py
&general
  RHSMode = 3
/
&geometryParameters
...
print("=== tools/paper_benchmarks/low_collisionality_validity.py ===", flush=True)
