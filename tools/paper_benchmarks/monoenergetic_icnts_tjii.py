...
Run (from the repo root):
  SFINCS_FORTRAN_EXE=/path/to/sfincs python tools/paper_benchmarks/monoenergetic_icnts_tjii.py
"""
...
! Generated by tools/paper_benchmarks/monoenergetic_icnts_tjii.py
&general
  RHSMode = 3
/
&geometryParameters
...
print("=== tools/paper_benchmarks/monoenergetic_icnts_tjii.py ===", flush=True)
