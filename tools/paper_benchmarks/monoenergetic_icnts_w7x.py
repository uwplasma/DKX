...
Run (from the repo root):
  SFINCS_FORTRAN_EXE=/path/to/sfincs python tools/paper_benchmarks/monoenergetic_icnts_w7x.py
"""
...
! Generated by tools/paper_benchmarks/monoenergetic_icnts_w7x.py
&general
  RHSMode = 3
/
&geometryParameters
...
print("=== tools/paper_benchmarks/monoenergetic_icnts_w7x.py ===", flush=True)
