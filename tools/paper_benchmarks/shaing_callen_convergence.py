...
Run (from the repo root):
  SFINCS_FORTRAN_EXE=/path/to/sfincs python tools/paper_benchmarks/shaing_callen_convergence.py
"""
...
! Generated by tools/paper_benchmarks/shaing_callen_convergence.py
&general
  RHSMode = 3
/
&geometryParameters
...
print("=== tools/paper_benchmarks/shaing_callen_convergence.py ===", flush=True)
